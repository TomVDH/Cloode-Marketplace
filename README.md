...
|--------|---------|-------------|
| [cabinet-of-imd](./cabinet-of-imd) | 1.4.0 | The Cabinet of IMD Agents — a crew of specialized web development agents with gated handoffs, scope management, and team dynamics. |
...
├── cabinet-of-imd/         # Plugin: Cabinet of IMD Agents
│   ├── .claude-plugin/     # Plugin metadata (plugin.json)
│   ├── skills/             # 15 invocable skills
